...
General discussion of RMTC security posture.
...
_Assuming RMTC defines a data file format, a discussion of what a user should expect happens when operating on a valid or invalid RMTC data file._

## Runtime Library Expectations

_Assuming RMTC defines a callable API / library, a discussion of how the library is expected to behave, how it handles erroneous inputs / does input sanitization, how it returns errors._
